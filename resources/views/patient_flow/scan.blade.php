        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-start gap-3">
                    <div>
                        <h4 class="mb-1">Patient QR Scan Summary</h4>
...
<div class="row g-3">
    <div class="col-lg-6">
        <div class="card h-100">
            <div class="card-body">
                <h5 class="card-title">Previous Vitals</h5>
                <div class="table-responsive">
                    <table class="table table-sm align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="text-muted">No previous vitals found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    <div class="col-lg-6">
        <div class="card h-100">
            <div class="card-body">
                <h5 class="card-title">Recent Consultation History</h5>
                <div class="table-responsive">
                    <table class="table table-sm align-middle mb-0">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="3" class="text-muted">No consultation history found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
