    ...
    <div class="card patient-form-card">
        <div class="card-body">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
                <div>
                    <h4 class="card-title mb-1">{{ $patient->patient_code ?: 'Patient Record' }}</h4>
                    <p class="text-muted mb-0">Update patient registration details.</p>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-2">
                        ...
                        <select name="title" class="form-select">
                            ...
                            @foreach($titles as $title)
                                <option value="{{ $title }}" @selected(old('title', $patient->title) === $title)>{{ $title }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="dob" id="dob" value="{{ old('dob', $patient->dob) }}" class="form-control" required>
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Age</label>
                        <input type="number" name="age" id="age" value="{{ old('age', $patient->age) }}" class="form-control" min="0" max="120">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">NIC <span class="text-danger">*</span></label>
                        <input type="text" name="nic" value="{{ old('nic', $patient->nic) }}" class="form-control" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="province" id="province" class="form-select">
                            ...
                            @foreach($provinces as $province)
                                <option value="{{ $province }}" @selected(old('province', $patient->province) === $province)>{{ $province }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="district" id="district" class="form-select" data-selected="{{ old('district', $patient->district) }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="gs_division" value="{{ old('gs_division', $patient->gs_division) }}" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="emergency_name" value="{{ old('emergency_name', $patient->emergency_name) }}" class="form-control">
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="chronic_conditions" class="form-control" rows="3">{{ old('chronic_conditions', $patient->chronic_conditions) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2 pt-3">
                ...
                <button type="submit" class="btn btn-gradient-primary">
                    <i class="mdi mdi-content-save me-1"></i> Update Patient
                </button>
            </div>
        </div>
    </div>
