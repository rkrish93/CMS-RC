                ...
                <form method="POST" action="{{ route('products.update', $product) }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="expiry_date" value="{{ $product->expiry_date ? $product->expiry_date->format('Y-m-d') : '' }}" class="form-control">
                            @error('expiry_date')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="number" name="minimum_stock" value="{{ $product->minimum_stock }}" class="form-control" min="1" required>
                            @error('minimum_stock')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
